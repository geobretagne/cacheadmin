...
Ext.onReady(function () {
    ...
    formSelectedCarte = new GeoExt.form.FormPanel({
        ...
        buttons: [{
            id: 'ddd',
            text: 'Afficher',
            tooltip: 'Visualiser le tms selectionne',
            disabled: true,            
            iconCls: 'add',
            handler: function () {
                addtms();
    ...
    var formAdmin = new GeoExt.form.FormPanel({
        ...
        items: [{
            ...
            {
                xtype: 'checkbox', 
                fieldLabel: "Utiliser l'étendue du cadre", 
                name: 'useext', 
                id: 'ccc' 
            },            
            {
    ...
    gridTasks = new Ext.grid.GridPanel({
        ...
        tbar: [{
            ...
            text: 'Kill tasks',
            tooltip: 'Kill de tous les tasks (bientot)',
            iconCls: 'remove',
            disabled: true
        }],
        store: storetasks,
    ...
    function submitform() {
        ...
        if (Ext.getCmp('ccc').getValue() == true) {
            if (Ext.getCmp('cbproj1').getValue() == Ext.getCmp('textproj').getValue()) {
                ...
                alert("les projection de l'etendue courante et du service selectionne ne sont pas en coherence !");
                return;
            }
        }
